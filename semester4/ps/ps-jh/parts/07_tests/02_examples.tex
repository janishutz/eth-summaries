...
\howto{Tests}{
    ...
    \begin{enumerate}
        ...
        \item Teststatistik: Basierend auf Verteilung von $\cX_k$ und Bekanntheit von Parametern
              (bspw. mit Theoremen von \ref{sec:dist-normal}, wie Normalisierung,
...
\bi{Approximative Teststatistik} Normalisierung unter $H_0$, also $T = \frac{x_n - \E[S_n]}{\V[S_n]}$, mit $x_n$ Realisierung, $S_n$ wie immer
