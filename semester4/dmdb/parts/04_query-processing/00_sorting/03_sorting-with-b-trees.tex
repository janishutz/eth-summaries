...
The operating principle is very simple, abusing the linked lists in the leafs of the B+ tree, leading to each page being fetched just once,
instead of one page fetch (= I/O) per record, if the data is not clustered, we have one I/O per record, which is bad.
